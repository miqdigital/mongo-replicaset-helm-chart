...
| `backup.enabled`                       | Mongo dump backup enable flag                                     | `false`                                                |
| `backup.s3Path`                       | S3 location where backup is to written                                     | `NA`                                                |
| `backup.cron`                       | Cron Interval for backup job                                     | `00 * * * * `                                                |
| `backup.annotations.iam.amazonaws.com/role`                       | IAM role with write access to S3                                     | `00 * * * * `                                                |
